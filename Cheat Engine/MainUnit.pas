...
begin
  ...
  try
    ...
    begin
      ...
      ScanType.Items.Add(strMonitorValue);
    ...
    begin
      ...
      begin
        ...
        case scantype.ItemIndex of
          ...
          1: result:=soMonitorValue;
          2: result:=soBiggerThan;
          3: result:=soSmallerThan;
          4: result:=soValueBetween;
          5: result:=soUnknownValue;
        end;
      end
      else
      begin
        ...
        case scantype.itemindex of
          ...
          3: result:=soSmallerThan;
          4: result:=soValueBetween;
          5: result:=soIncreasedValue;
          6: result:=soIncreasedValueBy;
          7: result:=soDecreasedValue;
          8: result:=soDecreasedValueBy;
          9: result:=soChanged;
          10: result:=soUnchanged;
        end;
      end;
    end;
  end;
