  ...
  try
    ...
    begin
      ...
      try
        ...
        reg.WriteBinaryData('New Scan-Monitor Values',frameHotkeyConfig.newhotkeys[21][0],10);
        ...
        reg.WriteBinaryData('Next Scan-Monitor Values',frameHotkeyConfig.newhotkeys[24][0],10);
        reg.WriteBinaryData('Increased Value Hotkey',frameHotkeyConfig.newhotkeys[25][0],10);
        reg.WriteBinaryData('Decreased Value Hotkey',frameHotkeyConfig.newhotkeys[26][0],10);
        reg.WriteBinaryData('Changed Value Hotkey',frameHotkeyConfig.newhotkeys[27][0],10);
        reg.WriteBinaryData('Unchanged Value Hotkey',frameHotkeyConfig.newhotkeys[28][0],10);
        reg.WriteBinaryData('Same as first scan Hotkey',frameHotkeyConfig.newhotkeys[29][0],10);

        reg.WriteBinaryData('Undo Last scan Hotkey',frameHotkeyConfig.newhotkeys[30][0],10);
        reg.WriteBinaryData('Cancel scan Hotkey',frameHotkeyConfig.newhotkeys[31][0],10);
        reg.WriteBinaryData('Debug->Run Hotkey',frameHotkeyConfig.newhotkeys[32][0],10);
